...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BAcVa-AE.mjs')
  },
  {
    name: "project-list",
    path: "/project/list",
    component: () => import('./list-jPCiavA7.mjs')
  }
];
...
const ui_g68iMaCVpJW9U4z2taDE3N4qj_cbABgPYUk878LCmQ8 = /* @__PURE__ */ defineNuxtPlugin(() => {
  return;
});
...
const plugins = [
  ...
  ui_g68iMaCVpJW9U4z2taDE3N4qj_cbABgPYUk878LCmQ8,
  prerender_server_sqIxOBipVr4FbVMA9kqWL0wT8FPop6sKAXLVfifsJzk
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-CXSt_FPW.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BtyXxEIz.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-2-c54m1v.mjs'));
