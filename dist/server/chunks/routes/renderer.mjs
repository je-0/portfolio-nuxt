...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no, viewport-fit=cover"},{"charset":"utf-8"}],"link":[{"rel":"shortcut icon","type":"image/x-icon","href":"./favicons/favicon_16.ico"},{"rel":"stylesheet","href":"./lib/swiper.min.css"}],"style":[],"script":[{"src":"./lib/gsap.min.js","defer":true},{"src":"./lib/ScrollTrigger.js","defer":true},{"src":"./lib/swiper.min.js","defer":true}],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no, viewport-fit=cover","title":"LIM.JE.YOUNG"};
